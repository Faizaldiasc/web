					...
					<div class="col-md-6 b-right">
						...
						<h3 align="center">Login Admin</h3>
									<?php
  									...
  									?>
						 <form action="<?php echo base_url('Controller_Login_Admin/ceklogin')?>" method="post">
						<div class="input-group">
 							 <div class="input-group-prepend">
    							<span class="input-group-text" id="basic-addon1">
 										 ...
 										 <input type="text" name="username_admin" class="form-control" placeholder="Username" aria-label="Username" aria-describedby="basic-addon1">
										</div>
 							 ...
 							 <div class="input-group-prepend">
    							<span class="input-group-text" id="basic-addon1">
 										 ...
 										 <input type="Password" name="password_admin" class="form-control" placeholder="Password" aria-label="Username" aria-describedby="basic-addon1">
										</div>
