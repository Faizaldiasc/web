        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-12 col-lg-6">
                    <div class="contact--info mt-50 mb-100" style="position: relative; left: 300px;">
                        <h4>Contact Info</h4>
                        <ul class="contact-list">
                            <li>
                                <h6><i class="fa fa-clock-o" aria-hidden="true"></i> Business Hours</h6>
                                <h6>10:00 AM - 21:00 PM</h6>
                            </li>
                            <li>
                            ...
                            <li>
                               ...
                               <h6>admin@digitalcreative.web.id</h6>
                            </li>
                            <li>
                                <h6><i class="fa fa-map-pin" aria-hidden="true"></i> Address</h6>
                               <h6>Jl. Binjai 30 Ilir, Ilir Barat II, Palembang</h6>
                            </li>
                        </ul>
                    </div>
                </div>
