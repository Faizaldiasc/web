			...
			<div class="col-md-6">
				<div class="h-100vh row justify-content-center align-items-center">
					<div class="col-md-6 b-right">
						...
						<h3 align="center">Login Mentor</h3>
							<?php
  							...
  							?>
						<form action="<?php echo base_url('Controller_Login_Mentor/ceklogin')?>" method="post">
						<div class="input-group">
 							 <div class="input-group-prepend">
    							<span class="input-group-text" id="basic-addon1">
 										 ...
 										 <input type="text" name="username_mentor" class="form-control" placeholder="Username" aria-label="Username" aria-describedby="basic-addon1">
										</div>
 							 ...
 							 <div class="input-group-prepend">
    							<span class="input-group-text" id="basic-addon1">
 										 ...
 										 <input type="Password" name="password_mentor" class="form-control" placeholder="Password" aria-label="Username" aria-describedby="basic-addon1">
										</div>
					...
					<div class="col-md-5">
						<div class="text text-center">
							...
							<p>Tempatnya Nongkrong Sambil Belajar!</p>
						</div>
					</div>
